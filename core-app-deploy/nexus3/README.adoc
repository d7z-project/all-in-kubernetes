...
----
# 登陆 docker
podman login registry.internal.d7z.net
podman pull docker.io/library/nginx:1.21.1
podman tag docker.io/library/nginx:1.21.1 registry.internal.d7z.net/library/nginx:1.21.1
podman push registry.internal.d7z.net/library/nginx:1.21.1
----
...
前往 `https://nexus.internal.d7z.net/#admin/repository/repositories`，点击新建，选择 `maven2 (hosted)`, 创建本地私有仓库。具体配置如下：

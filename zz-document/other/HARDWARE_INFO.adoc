...
所有机器均采用 link:https://www.debian.org/releases/bullseye/[Debian "bullseye"] 作为底层操作系统，并在物理机配置了定时备份任务，具体配置请查看 link:../../cluster-deploy/00-init-node/SYSTEM.adoc[Debian 系统配置]。
